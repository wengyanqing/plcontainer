...
release_plcontainer() {
  ...
  cp plcontainer_gpdb_ubuntu18_build/plcontainer-*.gppkg release_bin_ubuntu18/plcontainer-${PLCONTAINER_VERSION}.${PLCONTAINER_RELEASE}-gp6-ubuntu18.04_x86_64.gppkg
  # release centos 7
